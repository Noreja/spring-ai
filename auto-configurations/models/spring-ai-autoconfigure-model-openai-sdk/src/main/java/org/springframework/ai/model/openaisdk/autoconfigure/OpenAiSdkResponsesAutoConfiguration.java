...
import org.springframework.ai.openaisdk.OpenAiSdkResponsesModel;
...
/**
 * {@link AutoConfiguration Auto-configuration} for OpenAI Responses API model using the
 * OpenAI SDK.
 *
 * @author Noreja
 */
@AutoConfiguration(after = { ToolCallingAutoConfiguration.class })
@EnableConfigurationProperties({ OpenAiSdkConnectionProperties.class, OpenAiSdkResponsesProperties.class })
@ConditionalOnProperty(name = "spring.ai.openai-sdk.responses.enabled", havingValue = "true")
public class OpenAiSdkResponsesAutoConfiguration {

	@Bean
	public OpenAiSdkResponsesModel openAiResponsesModel(OpenAiSdkConnectionProperties commonProperties,
			OpenAiSdkResponsesProperties responsesProperties, ToolCallingManager toolCallingManager,
		...
		OpenAiSdkAutoConfigurationUtil.ResolvedConnectionProperties resolvedConnectionProperties = OpenAiSdkAutoConfigurationUtil
			.resolveConnectionProperties(commonProperties, responsesProperties);
		...
		var responsesModel = new OpenAiSdkResponsesModel(openAIClient, openAIClientAsync,
				responsesProperties.getOptions(), toolCallingManager,
